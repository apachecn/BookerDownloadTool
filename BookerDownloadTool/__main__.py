...
def main():
    ...
    bili_parser.add_argument("--start_page", type=int, default=0, help="start page")
    ...
    bili_kw_parser.add_argument("--start_page", type=int, default=0, help="start page for every video")
    ...
    bili_home_parser.add_argument("--start_page", type=int, default=0, help="start page for every video")
